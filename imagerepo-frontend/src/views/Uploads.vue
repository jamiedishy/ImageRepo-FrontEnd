          ...
          <b-row cols="3" class="align-self-md-stretch">
            <div v-for="image in imageData" :key="image.index">
              ...
              >
                ...
                <b-button pill variant="primary" v-b-modal="image._id">Edit</b-button>
                ...
                <b-modal :id="image._id" :title="'Edit ' + image.name">
                    ...
                    <div slot="modal-footer">
                        <b-button @click="editImage(image)" pill class="mr-3" variant="success">Update</b-button>
                        <b-button @click="deleteImage(image)" pill variant="danger">Delete</b-button>
                    </div>
                </b-modal>
              </b-card>
            </div>
...
export default {
  ...
  methods: {
    ...mapActions(["getImageData", "storeImageBlobs", "deleteImageData", "editImageData"]),
