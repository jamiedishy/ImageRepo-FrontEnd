<template>
  <div class="cms">
    ...
    <b-row class="mt-2">
      <b-col lg="10" class="pb-2">
        <b-form-file v-model="file" @change="previewImage" ref="file-input" class="mb-2"></b-form-file>
  ...
  >         
                <b-card-text>
                  <b-form-input v-model="name" placeholder="Enter image name"></b-form-input>
                  <b-form-input class="mt-3" v-model="price" placeholder="Enter image price"></b-form-input>
                </b-card-text>
            </b-card>
            <b-button href="#" @click="uploadImage()" class="mt-3" variant="primary">Upload</b-button>
        </b-col>
    </b-row>
